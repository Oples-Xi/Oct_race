...
#define R_1ji_In_Pin GPIO_PIN_4
#define R_1ji_In_GPIO_Port GPIOA
#define L_1ji_In_Pin GPIO_PIN_6
#define L_1ji_In_GPIO_Port GPIOA
#define L_2ji_In_Pin GPIO_PIN_7
#define L_2ji_In_GPIO_Port GPIOA
#define cunhuo_In_Pin GPIO_PIN_4
#define cunhuo_In_GPIO_Port GPIOC
#define dingwei_In_Pin GPIO_PIN_5
#define dingwei_In_GPIO_Port GPIOC
#define R_2ji_In_Pin GPIO_PIN_11
#define R_2ji_In_GPIO_Port GPIOF
#define pidai_duo_Pin GPIO_PIN_14
#define pidai_duo_GPIO_Port GPIOB
